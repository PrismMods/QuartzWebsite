...
Hides **A Dance of Fire and Ice**'s own per-hit judgement popups — the text that appears at the planet on every hit — one grade at a time.

## Where to find it

Open the Quartz menu in-game and pick **Visuals → Hide Judgements** from the sidebar.
...
!!! note
    This changes the base game's display rather than adding one of Quartz's own, which is why it lives on **Visuals** instead of **Overlay**. For Quartz's own on-screen tally of hit judgements, see [Judgement](judgement.md).
